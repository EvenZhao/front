...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concurrent: {
            target: {
                tasks: ['browserify:dev', 'sync', 'watch'],
                options: {
    ...
    grunt.registerTask('dist', ['clean:dist', 'clean:build', 'copy:build', 'browserify:dist', 'less:dist', 'cssmin', 'copy:dist', 'uglify:dist']);
    grunt.registerTask('test', ['clean:dist', 'clean:build', 'copy:build', 'browserify:test', 'less:dist', 'copy:dist', 'uglify:dist']);
    grunt.registerTask('alpha', ['clean:dist', 'clean:build', 'copy:build', 'browserify:alpha', 'less:dist', 'copy:dist', 'uglify:dist']);
