...
var WAPPanelRegister;
function init(dispatcher,store){
    if (WAPPanelRegister) {
        return WAPPanelRegister;
    }
    Dispatcher = dispatcher;
    var Store = store;
    WAPPanelRegister = React.createClass({
        ...
        _onClick_btnSendCode: function(e){
            ...
            if(!this.state.isSmsSent){
                ...
                Dispatcher.dispatch({
                    actionType: ActionTypes.GET_WAP_REGISTER_CODE,
        ...
        _onClickBySubmit: function(e){
            ...
            if (this.state.newPwd) {
                ...
                if (password.test(this.state.newPwd)) {
                    this.setState({
                        valid_newpwd: validmobile,
                        valid_newpwd_warn:_validmobile,
                        valid_newpwd_length: false
            ...
            Dispatcher.dispatch({
                actionType: ActionTypes.WAP_REGISTER,
        ...
        _onClickByBangDing: function(e){
            ...
            console.log('WAP_LOGINWAP_LOGINWAP_LOGINWAP_LOGIN');
            Dispatcher.dispatch({
                actionType: ActionTypes.WAP_LOGIN,
        ...
        componentDidMount: function() {
           store.addEventListener(this.Events.WAP_LOGIN_DONE,this._handleBIND_DONE);
           store.addEventListener(this.Events.WAP_REGISTER_DONE,this._handleREGISTER_DONE);
           store.addEventListener(this.Events.GET_WAP_REGISTER_CODE_DONE,this._handleGETREGISTERCODE_DONE);
        },
        componentWillUnmount: function() {
            clearInterval(countdown);
            store.removeEventListener(this.Events.WAP_LOGIN_DONE,this._handleBIND_DONE);
            store.removeEventListener(this.Events.WAP_REGISTER_DONE,this._handleREGISTER_DONE);
            store.removeEventListener(this.Events.GET_WAP_REGISTER_CODE_DONE,this._handleGETREGISTERCODE_DONE);
        },
    	render: function(){
            ...
            var cls_newpwd_length = cx('form-group ME-inline-input-group-warn', {'Me-Warn-div-none': !this.state.valid_newpwd_length});
                                    ...
                                    <div className="ME_register_main_div panel">
                                        ...
                                        <div className="ME_register_div" >
                                            ...
                                            <div className="ME_button_div">
                                                  <button type="button" className="btn btn-primary ME_btn_submit" onClick={this._onClickByBangDing}>登陆</button>
                                            </div>
                                ...
                                : 
                                        (
                                            <div className="ME_register_main_div panel">
                                                ...
                                                <div className={cls_newpwd_length}>
                                                    请输入6-16位密码，至少包含数字、字母或符号中的两种.
                                                </div>
                                                ...
                                                <div className="ME_tishi_div">
                                                    <a className="" onClick={this._onChangeChangeBinding}>已有帐号？速去登陆</a>
                                                </div>
                                            </div>
                                        </div>);
