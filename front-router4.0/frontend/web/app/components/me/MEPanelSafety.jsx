...
var MEPanelSafety = React.createClass({
	...
	render: function(){
        ...
        var cls_oldPw_warn=cx('form-group ME-inline-input-group-warn', {'Me-Warn-div-none': !this.state.valid_oldPw_warn});
        var cls_newPw = cx('form-group ME-inline-input-group', {'has-error': !this.state.valid_newPw});
        var cls_newPw_warn=cx('form-group ME-inline-input-group-warn', {'Me-Warn-div-none': !this.state.valid_newPw_warn});
        var cls_confirmpwd = cx('form-group ME-inline-input-group', {'has-error': !this.state.valid_confirmpwd});
        var cls_confirmpwd_warn=cx('form-group ME-inline-input-group-warn', {'Me-Warn-div-none': !this.state.valid_confirmpwd_warn});
        var cls_NewConfpwd_warn=cx('form-group ME-inline-input-group-warn', {'Me-Warn-div-none': !this.state.valid_NewConfpwd_warn});
    			...
    			<div className="form form-horizontal">
                    <div className={cls_oldPw}>
                        <div className="icon-input-head">
                            ...
                            <input type="password" className="form-control ME_register_div_input" ref="oldPw" id="oldpwd" value={this.state.oldPw} onChange={this.onChange_oldPw} placeholder="请输入您的当前密码"/>
                        </div>
                    </div>
                    ...
                    <div className={cls_newPw}>
                       <div className="icon-input-head">
                        <i className="fa fa-1x fa-lock"></i>
                            <input type="password" className="form-control ME_register_div_input" ref="newPw" id="newpwd" value={this.state.newPw} onChange={this.onChange_newPw}  placeholder="新的密码"/>
                        </div>
                    </div>
                    ...
                    <div className={cls_confirmpwd}>
                        <div className="icon-input-head">
                            <i className="fa fa-1x fa-lock"></i>
                            <input type="password" className="form-control ME_register_div_input" ref="confirmpwd" id="confirmpwd" placeholder="确认密码" onChange={this.onChange_cconfirmpwd} />
                        </div>
                    </div>
