/*
 * Author: Crane Leeon
 * 废弃（合并到PgtestPaper） by Tinahuang 2018/11/5
 * */
...
class PgTaskPaper extends React.Component {
	constructor(props) {
	    super(props);
		this.state = {
      testpaperList:[],
    ...
    var testpaperList = this.state.testpaperList.map((item,index)=>{
      ...
      return(
	              ...
	              <img src={count == length ? Dm.getUrl_img('/img/v2/icons/downNoTextPaper@2x.png') : Dm.getUrl_img('/img/v2/icons/downTextPaper@2x.png')} height="21" width="12" />
						...
						<div style={{...styles.answerDetail,display: this.state.isAnalysis ? 'block':'none'}}>
							<div style={{...styles.answerDiv,marginTop:25}}>
								...
								<span style={{fontSize:14,color:'#000000'}}>答案详解</span>
							</div>
        ...
        <div style={{...styles.top}}>
          <span style={{fontSize:14,color:'#333333',marginLeft:12,position:'relative',top:16}}>{this.state.task.name || ''}</span>
        </div>
