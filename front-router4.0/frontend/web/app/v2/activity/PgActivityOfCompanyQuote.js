...
class PgActivityOfCompanyQuote extends React.Component {
	constructor(props) {
    super(props);
    this.phone = '',
		this.wx_config_share_home = {
				...
				imgUrl: Dm.getUrl_img('/img/v2/activity/card_share.jpg'),
				type: 'link'
		};
		this.state = {
			title: 'PgHome',
		...
		return (
			...
			ref={(lessonList) => this.lessonList = lessonList}
				...
				<div style={{...styles.div,display:this.state.displayOne,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card1.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
				</div>
				<div style={{...styles.div,display:this.state.displayTwo,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card2.jpg`)} height={innerHeight} width={window.screen.width}  style={{...styles.image}}/>
				</div>
				<div style={{...styles.div,display:this.state.displayThree,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card3.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
				</div>
				<div style={{...styles.div,display:this.state.displayFour,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card4.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
				</div>
				<div style={{...styles.div,display:this.state.displayFive,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card5.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
				</div>
				<div style={{...styles.div,display:this.state.displaySix,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card6.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
				</div>
				<div style={{...styles.div,display:this.state.displaySeven,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
					<img src={Dm.getUrl_img(`/img/v2/activity/card7.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
				</div>
				...
				<div style={{...styles.div,display:this.state.displayEight,height:this.state.height,position:this.state.upDown ? 'relative':'absolute',bottom:0}}>
						<img src={Dm.getUrl_img(`/img/v2/activity/card8.jpg`)} height={window.innerHeight} width={window.screen.width} style={{...styles.image}}/>
					<div style={{...styles.from,opacity:0.7}}>
...
var styles = {
  ...
  div:{
	...
	//	height:100,
		...
		zIndex: 99,
	  height:devHeight*((devHeight-250)/667)
	}
};

export default PgActivityOfCompanyQuote;
