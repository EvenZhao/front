...
var t;
class AboutCima extends React.Component {
  constructor(props) {
      super(props);
      this.wx_config_share_home = {
  				title: 'CIMA·你职业发展的动力引擎',
  				desc: 'CIMA管理会计职业资格',
  				link: document.location.href + '',
  				imgUrl: Dm.getUrl_img('/img/v2/activity/cimaAbout.jpg'),
  				type: 'link'
  		}
      this.state={
        name:'',
  ...
  componentDidMount(){
    ...
    EventCenter.emit("SET_TITLE",'铂略财课-CIMA·你职业发展的动力引擎');
  ...
  render(){
    ...
    return(
      <div style={{...styles.container}}>
        ...
        <div style={{width:window.screen.width,height:window.screen.width/750*3704,marginTop:54}}>
          <img src={Dm.getUrl_img('/img/v2/activity/about_cima.jpg?t=20180130')} width={window.screen.width} height={window.screen.width/750*3704}/>
        </div>
